...
//   print(sayHello('REY')); // Output: Hello, REY!
// }
...
// printIdentity('Fahreiza  Taura Muhammadani', '2341720207'); 
// }
...
//   print(helloGreeter('REY'));    // Output: Hello, REY!
//   print(morningGreeter('REY')); // Output: Good morning, REY!
// }
...
(String, int) getMahasiswa() {
  String name = 'Fahreiza Taura Muhammadani';
  int entryYear = 2023;
