...
void main() {
  ...
  names1.add('Fahreiza Taura Muhammadani ');      // Replace with your name
  names1.add('2341720207');  // Replace with your student ID

  // Add elements to the second set using .addAll()
  names2.addAll(['Fahreiza Taura Muhammadani ', '2341720207']); // Replace with your details
